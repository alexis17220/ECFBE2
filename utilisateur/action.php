...
if (isset($_POST["valider"])) {
    ...
    echo 'test';
    $sql = "UPDATE event SET `titre`='" . htmlspecialchars(sanitizeInput($_POST['titre'])) . "', `description`='" . htmlspecialchars(sanitizeInput($_POST['description'])) . "', `image`='" . htmlspecialchars(sanitizeInput($_POST['image'])) . "'WHERE id_events='" . $_POST['id_events'] . "'";
