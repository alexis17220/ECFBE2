...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT DISTINCT i.id_events, nom,prenom, mail, username  FROM event AS e INNER JOIN categorie As c ON e.id_cat=c.id_cat INNER JOIN utilisateur AS u ON e.id_users=u.id_users INNER JOIN insevent AS i ON e.id_events=i.id_events WHERE e.id_events='" . $_GET['id'] . "'";
